...
public class ModeloTatico1442 extends ModeloTatico implements Serializable {
    public ModeloTatico1442 (Equipa eq) {
        super(eq);
        setPosicoes();
    }

    public ModeloTatico1442(ModeloTatico1442 m) {
        super(m.getEquipa());
        setPosicoes();
    }
    ...
    public void setPosicoes() {
        try {
            ...
            pos.put("Medio",new ArrayList<>(Arrays.asList(new Integer[] {-1,-1,-1, -1})));
            pos.put("Avancado",new ArrayList<>(Arrays.asList(new Integer[] {-1,-1})));
    ...
    public ModeloTatico clone() {
            return new ModeloTatico1442(this);
    }
}
